#https://github.com/FarmGTEx/PigGTEx-Pipeline-v0/blob/master/08_molQTL_mapping/TensorQTL/eGene_detection.R
library(qvalue)
library(data.table)
...
# Determine significance threshold with benjamini hochberg method
# Scricter than the qvalue method (assumes all are null)
